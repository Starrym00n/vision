...
uint8_t key_scan(uint8_t mode)
{
    ...
    if (key_up && (KEY0 == 0 || KEY1 == 0 || KEY2 == 0 || KEY3 == 0|| KEY4 == 0|| KEY5 == 0|| KEY6 == 0|| KEY7 == 0))  /* 按键松开标志为1, 且有任意一个按键按下了 */
    {
        delay_ms(10);           /* 去抖动 */
        key_up = 0;
        ...
        if (KEY7 == 0)  keyval = KEY7_PRES;
    }
    else if (KEY0 == 1 && KEY1 == 1 && KEY2 == 1 && KEY3 == 1 && KEY4 == 1 && KEY5 == 1 && KEY6 == 1 && KEY7 == 1) /* 没有任何按键按下, 标记按键松开 */
    {
        key_up = 1;
    }
